  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{data ? data.total_rooms : 0}</div>
          <p className="text-xs text-muted-foreground">available for next 30 days</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{occupancy ? occupancy.occupancy_rate_difference : "+0"}% from last 30 days</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{revenue ? revenue.revenue_difference : 0}% from last 30 days</p>
        </CardContent>
      </Card>
      {/* <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
